...
export const Toolbar = () => {
  ...
  return (
    <div className="md:h-full">
      <div className="hidden md:grid bg-white outline-1 outline-zinc-300 dark:bg-zinc-950 dark:outline-zinc-800 rounded-full mt-4 ml-4 w-[52px] h-[52px] place-content-center">
        <Image src={logo} alt="" className="p-3" />
      </div>
      <div className="border-t-[1px] border-t-zinc-300 max-h-[calc(100vh-30px)] bg-white dark:bg-zinc-950 dark:border-t-zinc-800 shadow-[6px_0_12px_-2px_#c3c3c3] dark:shadow-[6px_0_8px_-2px_#1e1e1e] | md:shadow-[0_0_8px_#c3c3c3] md:dark:shadow-[0_0_4px_#1e1e1e] md:m-4 md:border-0 md:outline-1 md:outline-zinc-300 md:dark:outline-zinc-800 md:rounded-full md:w-fit md:sticky md:top-4 md:mt-4 md:h-full md:max-h-[calc(100vh-52px-40px)]">
        <nav className="text-4xl flex md:flex-col md:h-full justify-center">
          <div className="md:grow flex gap-x-4 items-center md:flex-col">
            <Link
              href="calc"
              className={
                pathname === "/calc" ? activeLink + " md:rounded-t-full" : link
              }
            >
              <TbCalculatorFilled />
            </Link>
