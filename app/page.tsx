...
//     // In development, we want to bypass auth for easier testing.
...
const ROI = () => {
  ...
  return (
    <div className="font-sans flex flex-col gap-8 mb-20 items-center max-w-410 md:mx-auto md:w-fit">
      <PageHeader
      ...
      />
      <div className="flex flex-col px-2 md:px-4 lg:px-6 xl:px-0 md:grid md:grid-cols-2 xl:grid-cols-3 gap-4">
        <div className="flex flex-col gap-4 p-4 outline outline-zinc-300 dark:outline-zinc-800 bg-white dark:bg-zinc-950 rounded-lg ">
          ...
          <div className="flex flex-col-reverse gap-1 w-max">
            ...
            <div className="peer flex flex-wrap-reverse gap-1">
              <input
                id="address"
                value={state.address}
                className="bg-zinc-100 dark:bg-zinc-900 outline outline-zinc-300 dark:outline-zinc-800 px-3 py-1 rounded-lg text-xl w-[150px] min-[350px]:w-auto"
        ...
        <div className="flex flex-col gap-4 p-4 outline outline-zinc-300 dark:outline-zinc-800 bg-white dark:bg-zinc-950 rounded-lg dark:border-white">
        ...
        <div className="flex flex-col gap-2 p-4 outline outline-zinc-300 dark:outline-zinc-800 bg-white dark:bg-zinc-950 rounded-lg dark:border-white md:row-span-2  xl:row-span-1 xl:col-span-3 xl:grid xl:grid-cols-subgrid xl:place-items-center">
        ...
        <div className="flex flex-col gap-4 p-4 outline outline-zinc-300 dark:outline-zinc-800 bg-white dark:bg-zinc-950 rounded-lg dark:border-white xl:col-start-3 xl:row-start-1">
          <div className="flex justify-between">
        ...
        <div className="flex flex-col gap-4 p-4 outline outline-zinc-300 dark:outline-zinc-800 bg-white dark:bg-zinc-950 rounded-lg dark:border-white xl:col-span-3">
